...
class AdoptionPhotoUpload extends StatefulWidget {
  const AdoptionPhotoUpload({Key? key}) : super(key: key);

  @override
  _PhotoUploadState createState() => _PhotoUploadState();
}

class _PhotoUploadState extends State<AdoptionPhotoUpload> {
